...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <div class="header-title">
      <h1>{{ __('messages.edit_package') }}</h1>
      <small>{{ __('messages.update_subscription_package') }}</small>
      <ol class="breadcrumb hidden-xs">
        <li><a href="{{ route('dashboard') }}"><i class="pe-7s-home"></i> {{ __('messages.home') }}</a></li>
        <li class="active">{{ __('messages.edit_package') }}</li>
      </ol>
    </div>
  </section>
          ...
          <div class="panel-body">
            ...
            <form action="{{ route('packages.update', $package->id) }}" method="POST">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" id="status" name="status">
                    <option value="active" {{ old('status', $package->status)=='active'?'selected':'' }}>{{ __('messages.active') }}</option>
                    <option value="inactive" {{ old('status', $package->status)=='inactive'?'selected':'' }}>{{ __('messages.inactive') }}</option>
                  </select>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="number" class="form-control" id="duration_days" name="duration_days"
                         value="{{ old('duration_days', $package->duration_days) }}" placeholder="e.g. 30">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="signal_limit" name="signal_limit"
                         value="{{ old('signal_limit', $package->signal_limit) }}" placeholder="Leave blank for unlimited">
                ...
                <div class="form-group col-md-12">
                  ...
                  <textarea class="form-control" id="description" name="description" rows="4"
                            placeholder="Write package details...">{{ old('description', $package->description) }}</textarea>
              ...
              <div class="col-sm-12 reset-button">
                ...
                <button type="submit" class="btn btn-success">{{ __('messages.update_package') }}</button>
              </div>
            </form>
          </div>
