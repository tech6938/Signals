...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <div class="header-title">
      ...
      <small>{{ __('messages.permission_table') }}</small>
      ...
      <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
          <div class="panel-heading">
            ...
            <!--    <i class="fa fa-plus" aria-hidden="true"></i> Add permissions-->
            <!--  </a>-->
            <!--</div>-->
          </div>
              ...
              <table class="table table-bordered table-hover">
                ...
                <tbody id="tableBody">
                  ...
                  <tr>
                    ...
                    <!--<td class="no-print">-->
                    <!--  <a href="{{ route('permissions.edit', $permission->id) }}"><i class="fa fa-pencil" style="color:#007BFF;"></i></a> |-->
...
<script>
  function fetchData(page = 1) {
    ...
    fetch(`{{ route('permissions.index') }}?page=${page}&query=${query}&perPage=${perPage}`, {
        headers: {
